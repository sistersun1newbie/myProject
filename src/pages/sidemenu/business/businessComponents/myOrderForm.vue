<template>
  <div>
    <el-form :model="pageData"
        ...
        <el-form-item :label="$t('business.giftList.head')"
          ...
          <ul class="el-upload-list el-upload-list--picture-card">
            <li class="el-upload-list__item  ">
              <img :src="base64Img||pageData.busiItem.itemIcon"
                   alt=""
      ...
      <el-col :span="$store.getters.isMobile?24:11">
        <el-form-item :label="$t('business.myOrderList.state')"
                      label-width="150px"
                      prop="typeZhCnName">
          <el-input v-model="pageData.status"
                    auto-complete="off"
                    :disabled="disabled" />
        </el-form-item>
      </el-col>
     <el-col :span="$store.getters.isMobile?24:11">
        <el-form-item :label="$t('business.myOrderList.name')"
                      label-width="150px"
                      prop="typeJaJpName">
          <el-input v-model="pageData.busiItem.itemName"
                    auto-complete="off"
                    :disabled="disabled" />
        </el-form-item>
      </el-col>
     <!-- <el-col :span="$store.getters.isMobile?24:11">
      ...
      <el-col :span="$store.getters.isMobile?24:11">
        <el-form-item :label="$t('business.myOrderList.num')"
                      label-width="150px"
                      prop="typeEnUsName">
          <el-input v-model="pageData.count"
                    auto-complete="off"
                    :disabled="disabled" />
        </el-form-item>
      </el-col>
  		<el-col :span="$store.getters.isMobile?24:11">
        <el-form-item :label="$t('business.myOrderList.total')"
                      label-width="150px"
                      prop="typeEnUsName">
          <el-input v-model="pageData.totalPrice"
                    auto-complete="off"
                    :disabled="disabled" />
        </el-form-item>
      </el-col>
